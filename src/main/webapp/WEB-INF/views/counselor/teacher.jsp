...
<div class="layui-row">
    <div class="layui-col-xs12">
        <div class="grid-demo grid-demo-bg1">
            <!-- 模块名 -->
            <blockquote class="layui-elem-quote">教师管理</blockquote>
            <%--            操作--%>
            <div class="top">
            ...
            <%--            表格--%>
            <div class="center">
                <table id="demo" lay-filter="teacherfilter"></table>
            </div>
        </div>
    </div>
</div>
...
<script src="${ctx}/resources/js/counselor/counselor_teacher.js" type="application/javascript"></script>
</body>
</html>
