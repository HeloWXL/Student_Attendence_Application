                ...
                <ul class="mui-table-view">
                    <li class="mui-table-view-cell">
                        <div class="mui-input-row">
                            <label>姓名：</label>
                            <input type="text" class="mui-input-clear" disabled="true" id="studentname" value="${studentsession.studentName}">
                        </div>
                        <div class="mui-input-row">
                            <label>学号：</label>
                            <input type="text" class="mui-input-clear"  disabled="true" id="studentsno" value="${studentsession.studentSno}">
                        </div>
                        <div class="mui-input-row">
                            <label>标题：</label>
